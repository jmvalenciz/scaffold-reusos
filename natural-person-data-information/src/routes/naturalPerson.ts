...
import { NaturalPersonValidator, type NaturalPerson } from "../schemas/NaturalPerson.js";
...
router.post("/retreive-customer-data",
  describeRoute({
  ...
  async c=>{
    var document: NaturalPersonId = await c.req.json();
    try {
